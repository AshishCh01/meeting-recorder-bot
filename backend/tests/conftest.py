...
# `560 passed, 68 skipped` and exits **0**.
#
# Those 68 are not filler. They are B1's atomicity gate, C3's
...
# still get the 560 tests that do not need one, and be told what they missed
# rather than handed a red suite.
#
# Deliberately "no skips at all" rather than "no *Redis* skips". This suite has
# no legitimately-conditional test today (with both services: 628 passed, 0
